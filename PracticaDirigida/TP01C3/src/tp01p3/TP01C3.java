...
public class TP01C3 {
    public static void main(String[] args) {
        ...
        String msg="Bienvenido\nLe ayudaremos a transcribir el monto(en soles) que desee.\nCabe resaltar que el presente transcriptor\ntiene una cifra limite de 9 999 999.99 soles.\nPor favor ingrese una cifra dentro de ese rango.\n";
        //ENTRADA DE DATOS
        do{
            soles = Double.parseDouble(JOptionPane.showInputDialog(null,msg+"Ingrese el valor: ","Entrada de Datos",JOptionPane.QUESTION_MESSAGE));
        }while(soles<0||soles>9999999.99);
        ...
        JOptionPane.showMessageDialog(null,mensaje+MLL+CML+" "+DML+ML+" "+C+" "+D+U+" CON "+cents+"/100 NUEVO(S) SOL(ES)");
