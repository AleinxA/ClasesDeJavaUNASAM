...
public class TP01C2 {
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "Bienvenido le ayudaremos a realizar los calculos con dos numeros complejos.\nCada numero complejo tiene la forma\n z=a + bi(en el primer numero)\nz=c + di(en el segundo numero)\nA continuación se le pedira los valores de a, b, c y d respectivamente.","Información previa",JOptionPane.INFORMATION_MESSAGE);
        //Entrada
        a = Double.parseDouble(JOptionPane.showInputDialog(null, "Ingrese la parte REAL del PRIMER Numero Complejo(a)", "Datos A",JOptionPane.QUESTION_MESSAGE));
        b = Double.parseDouble(JOptionPane.showInputDialog(null, "Ingrese la parte IMAGINARIA del PRIMER Numero Complejo(b)", "Datos A",JOptionPane.QUESTION_MESSAGE));
        c = Double.parseDouble(JOptionPane.showInputDialog(null, "Ingrese la parte REAL del SEGUNDO Numero Complejo(c)", "Datos B",JOptionPane.QUESTION_MESSAGE));
        d = Double.parseDouble(JOptionPane.showInputDialog(null, "Ingrese la parte IMAGINARIA del SEGUNDO Numero Complejo(d)", "Datos B",JOptionPane.QUESTION_MESSAGE));
        //PROCESO
        //SUMA
        pRealS=a+c;
        pImgS=b+d;
